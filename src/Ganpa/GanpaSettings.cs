...
namespace Ganpa
{
    ...
    /// Ganpa settings
    /// </summary>
    public class GanpaSettings
    {
        internal readonly Encoding Encoding = Encoding.UTF8;

        private const string FEATURE_TOGGLE_FILENAME = "ganpa.toggles.json";
        private const string ETAG_FILENAME = "ganpa.etag.txt";

        /// <summary>
        /// Gets the version of ganpa client running.
        /// </summary>
        public string SdkVersion { get; } = GetSdkVersion();

        /// <summary>
        /// Gets or set the uri for the backend ganpa server.
        /// 
        /// Default: http://ganpa.herokuapp.com/api/
        /// </summary>
        public Uri GanpaApiUri { get; set; } = new Uri("http://ganpa.herokuapp.com/api/");
        ...
        /// This provider will be called before each outgoing request to the ganpa server.
        /// </summary>
        public IGanpaCustomHttpHeaderProvider GanpaCustomHttpHeaderProvider { get; set; } =
            new DefaultCustomHttpHeaderProvider();

        /// <summary>
        /// Gets or sets the ganpa context provider. This is needed when using any of the activation strategies 
        /// that needs application specific context like userid etc.
        /// 
        /// Default: A provider with no context.
        /// </summary>
        public IGanpaContextProvider GanpaContextProvider { get; set; } = new DefaultGanpaContextProvider();
        ...
        /// </summary>
        public IGanpaScheduledTaskManager ScheduledTaskManager { get; set; } = new SystemTimerScheduledTaskManager();

        /// <summary>
        /// INTERNAL: Gets or sets an api client instance. Can be used for testing/mocking etc.
        /// </summary>
        internal IGanpaApiClient GanpaApiClient { get; set; }

        /// <summary>
        /// INTERNAL: Gets or sets the file system abstraction.
        /// Can be used for testing/mocking etc.
        /// </summary>
        internal IFileSystem FileSystem { get; set; }

        /// <summary>
        /// Gets or sets the toggle bootstrap provider (file, url, etc.).
        /// Can be used for testing/mocking etc.
        /// </summary>
        ...
        /// <summary>
        /// INTERNAL: Gets or sets if the feature toggle fetch should be immediately scheduled.
        /// Used by the client factory to prevent redundant initial fetches.
        /// </summary>
        ...
        private static string GetSdkVersion()
        {
            ...
            return $"ganpa-client-dotnet:v{version}";
        }
        ...
        /// <summary>
        /// Returns info about the ganpa setup.
        /// </summary>
        public override string ToString()
        {
            var sb = new StringBuilder("## Ganpa settings ##");
            ...
            sb.AppendLine($"Context provider: {GanpaContextProvider.GetType().Name}");
