namespace Ganpa
{
    ...
    /// <summary>
    /// A context which the feature request should be validated against.
    /// Usually scoped to a web request through an implementation of IGanpaContextProvider.
    /// </summary>
    public class GanpaContext
    {
        ...
        public GanpaContext(string appName, string environment, string userId, string sessionId, string remoteAddress,
        ...
        public GanpaContext ApplyStaticFields(GanpaSettings settings)
        {
        ...
        internal class Builder
        {
            ...
            public Builder(GanpaContext context)
            {
            ...
            public GanpaContext Build()
                => new GanpaContext(_appName, _environment, _userId, _sessionId, _remoteAddress, _currentTime,
                    _properties);
        }
    }
}