...
namespace Ganpa
{
    /// <inheritdoc />
    /// <summary>
    /// Ganpa Feature Toggle Service
    /// </summary>
    public interface IGanpa : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="toggleName">The name of the toggle</param>
        /// <param name="context">The Ganpa context to evaluate the toggle state against</param>
        bool IsEnabled(string toggleName, GanpaContext context);
        ...
        /// <param name="context">The Ganpa context to evaluate the toggle state against</param>
        /// <param name="defaultSetting">Default value to return if toggle is not defined</param>
        bool IsEnabled(string toggleName, GanpaContext context, bool defaultSetting);
        ...
        /// <param name="defaultValue">If a toggle is not found, the default value will be returned.</param>
        /// <returns>A weighted variant or the supplied default value if feature is not available</returns>
        Variant GetVariant(string toggleName, GanpaContext context, Variant defaultValue);
        ...
        /// /// <param name="context">The Ganpa context to evaluate the toggle state against.</param>
        /// <returns>A list of available variants.</returns>
        IEnumerable<VariantDefinition> GetVariants(string toggleName, GanpaContext context);
