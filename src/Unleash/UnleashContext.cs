namespace Unleash
{
    ...
    public class UnleashContext : Yggdrasil.Context
    {
        ...
        public UnleashContext(string appName, string userId, string sessionId, string remoteAddress, DateTimeOffset? currentTime, Dictionary<string, string> properties)
        {
            AppName = appName;
            UserId = userId;
            SessionId = sessionId;
        ...
        internal class Builder
        {
            ...
            public UnleashContext Build()
                => new UnleashContext(_appName, _userId, _sessionId, _remoteAddress, _currentTime, _properties);
        }
    }
}
